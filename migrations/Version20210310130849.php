 ...
 */
final class Version20210310130849 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cours CHANGE professeur_id professeur_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cours CHANGE professeur_id professeur_id INT NOT NULL');
    }
}
